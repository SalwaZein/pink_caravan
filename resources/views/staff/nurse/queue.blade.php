...
<x-staff-shell :role="$sidebarRole" :route="$route">
    <div class="pc-anim">
        ...
        <div class="pc-tbl-wrap" style="background:#fff;border:1px solid #EFE2EA;border-radius:16px;box-shadow:0 3px 14px rgba(120,60,90,.05);">
            <div class="pc-tbl" style="display:grid;grid-template-columns:150px 1.4fr 60px 120px 130px 100px;gap:12px;padding:14px 20px;background:#FAF4F7;font-size:11.5px;font-weight:700;letter-spacing:.06em;text-transform:uppercase;color:#9A8F97;">
            ...
            @forelse ($queue as $p)
                <div class="pc-tbl" style="display:grid;grid-template-columns:150px 1.4fr 60px 120px 130px 100px;gap:12px;align-items:center;padding:13px 20px;border-top:1px solid #F3E7EE;font-size:13.5px;">
